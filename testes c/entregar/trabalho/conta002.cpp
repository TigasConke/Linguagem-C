/*2) Fa�a em C um programa que leia um arquivo texto, via 
linha de comando (usando passagem de parametros pela funcao 
main), e mostre a quantidade de caracteres, palavras e linhas*/
...
int main(int argc, char *argv[]){
	...
	fpi=fopen(argv[1], "r");
	fpi=fopen("C:\\Users\\roger\\Desktop\\testes c\\entregar\\trabalho\\teste.txt", "r");
	if(!fpi){
